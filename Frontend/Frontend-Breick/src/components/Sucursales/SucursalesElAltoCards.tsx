...
const CardGrid: React.FC = () => {
  const cardsData = [
    {
      title: "Bombonería El Alto",
      imageUrl: "https://breick.com.bo/wp-content/uploads/2023/07/elalto.jpg",
      imageAlt: "Bombonería El Alto",
      description:
        "Zona:  Río Seco. Complejo Multicine. Av, Juan Pablo II casi equina Av. Costanera. Primer nivel, local N° A-16. Celular: 78982089 Horarios de atención:  Lunes a Domingo: 10:00 am a 9:00 pm",
